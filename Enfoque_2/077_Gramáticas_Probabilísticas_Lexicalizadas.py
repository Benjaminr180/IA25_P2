...
# Definimos una gramática probabilística lexicalizada simple
# Las producciones incluyen probabilidades, y las palabras también tienen probabilidades en función de su contexto
gramatica = {
    ...
    'N': [('perro', 0.4), ('gato', 0.3), ('pelota', 0.2), ('niño', 0.1)],  # N -> perro | gato | pelota | niño
